...
const characterData = {
  ...
  '男': { pinyin: 'nán', definition: 'male', emoji: '👦', level: 'P1' },
  '生': { pinyin: 'shēng', definition: 'born/student', emoji: '👶', level: 'P1' },
   '爱': { pinyin: 'ài', definition: 'love (like loving family!)', emoji: '❤️', level: 'P1' },
  '外': { pinyin: 'wài', definition: 'outside (out there!)', emoji: '🌳', level: 'P1' },
  '跑': { pinyin: 'pǎo', definition: 'run (fast like wind!)', emoji: '🏃', level: 'P1' },
  '站': { pinyin: 'zhàn', definition: 'stand (tall like tree!)', emoji: '🧍', level: 'P1' },
  '读': { pinyin: 'dú', definition: 'read (look at books!)', emoji: '📖', level: 'P1' },
  '写': { pinyin: 'xiě', definition: 'write (make words!)', emoji: '✍️', level: 'P1' },
  '学': { pinyin: 'xué', definition: 'learn/study (get smart!)', emoji: '📚', level: 'P1' },
  '校': { pinyin: 'xiào', definition: 'school (where you learn!)', emoji: '🏫', level: 'P1' },
  '老': { pinyin: 'lǎo', definition: 'old (like grandpa!)', emoji: '👴', level: 'P1' },
  '师': { pinyin: 'shī', definition: 'teacher (helps you learn!)', emoji: '👨‍🏫', level: 'P1' },
  '水': { pinyin: 'shuǐ', definition: 'water (drink it!)', emoji: '💧', level: 'P1' },
  '学': { pinyin: 'xué', definition: 'study (learning time!)', emoji: '📚', level: 'P1' },
  '门': { pinyin: 'mén', definition: 'door (open and close!)', emoji: '🚪', level: 'P1' },
  '车': { pinyin: 'chē', definition: 'car (beep beep!)', emoji: '🚗', level: 'P1' },
  '书': { pinyin: 'shū', definition: 'book (read stories!)', emoji: '📖', level: 'P1' },
  '笔': { pinyin: 'bǐ', definition: 'pen/pencil (write with it!)', emoji: '✏️', level: 'P1' },
  '白': { pinyin: 'bái', definition: 'white (like snow!)', emoji: '⚪', level: 'P1' },
  '高': { pinyin: 'gāo', definition: 'tall/high (reach up!)', emoji: '⬆️', level: 'P1' },
  '矮': { pinyin: 'ǎi', definition: 'short (not tall!)', emoji: '⬇️', level: 'P1' },
  '新': { pinyin: 'xīn', definition: 'new (brand new!)', emoji: '✨', level: 'P1' },
  '旧': { pinyin: 'jiù', definition: 'old (used before!)', emoji: '🕰️', level: 'P1' },
  '开': { pinyin: 'kāi', definition: 'open (make it open!)', emoji: '🔓', level: 'P1' },
  '关': { pinyin: 'guān', definition: 'close (shut it!)', emoji: '🔒', level: 'P1' },
  '年': { pinyin: 'nián', definition: 'year (birthday time!)', emoji: '📅', level: 'P1' },
  ...
  '科': { pinyin: 'kē', definition: 'science (learn about nature!)', emoji: '🔬', level: 'P4' },
  '技': { pinyin: 'jì', definition: 'technology/skill', emoji: '💻', level: 'P4' },
  '术': { pinyin: 'shù', definition: 'technique/art', emoji: '🎨', level: 'P4' },
  '电': { pinyin: 'diàn', definition: 'electricity (power!)', emoji: '⚡', level: 'P4' },
  '脑': { pinyin: 'nǎo', definition: 'brain/computer', emoji: '🧠', level: 'P4' },
  '网': { pinyin: 'wǎng', definition: 'internet/web', emoji: '🌐', level: 'P4' },
  '络': { pinyin: 'luò', definition: 'network (connected!)', emoji: '🔗', level: 'P4' },
  '信': { pinyin: 'xìn', definition: 'letter/message', emoji: '✉️', level: 'P4' },
  '报': { pinyin: 'bào', definition: 'newspaper/report', emoji: '📰', level: 'P4' },
  '杂': { pinyin: 'zá', definition: 'magazine/mixed', emoji: '📖', level: 'P4' },
  '志': { pinyin: 'zhì', definition: 'magazine/will', emoji: '📘', level: 'P4' },
  '广': { pinyin: 'guǎng', definition: 'broadcast/wide', emoji: '📻', level: 'P4' },
  '播': { pinyin: 'bō', definition: 'broadcast (on TV!)', emoji: '📺', level: 'P4' },
  '节': { pinyin: 'jiē', definition: 'program/festival', emoji: '📺', level: 'P4' },
  '目': { pinyin: 'mù', definition: 'program/item', emoji: '📋', level: 'P4' },
  '文': { pinyin: 'wén', definition: 'culture/writing', emoji: '📜', level: 'P4' },
  '化': { pinyin: 'huà', definition: 'culture/change', emoji: '🎭', level: 'P4' },
  '传': { pinyin: 'chuán', definition: 'tradition/pass on', emoji: '📿', level: 'P4' },
  '统': { pinyin: 'tǒng', definition: 'tradition/system', emoji: '🏛️', level: 'P4' },
  '历': { pinyin: 'lì', definition: 'history/calendar', emoji: '📅', level: 'P4' },
  '史': { pinyin: 'shǐ', definition: 'history', emoji: '📜', level: 'P4' },
  '古': { pinyin: 'gǔ', definition: 'ancient/old', emoji: '🏺', level: 'P4' },
  '代': { pinyin: 'dài', definition: 'generation/era', emoji: '👴', level: 'P4' },
  '现': { pinyin: 'xiàn', definition: 'modern/present', emoji: '⭐', level: 'P4' },
  '未': { pinyin: 'wèi', definition: 'future/not yet', emoji: '🔮', level: 'P4' },
  '艺': { pinyin: 'yì', definition: 'art/skill', emoji: '🎨', level: 'P4' },
  '音': { pinyin: 'yīn', definition: 'sound/music', emoji: '🎵', level: 'P4' },
  '乐': { pinyin: 'yuè', definition: 'music', emoji: '🎶', level: 'P4' },
  '曲': { pinyin: 'qǔ', definition: 'song/melody', emoji: '🎼', level: 'P4' },
  '演': { pinyin: 'yǎn', definition: 'perform/act', emoji: '🎭', level: 'P4' },
  '出': { pinyin: 'chū', definition: 'performance/exit', emoji: '🎪', level: 'P4' },
  '诗': { pinyin: 'shī', definition: 'poetry', emoji: '📜', level: 'P4' },
  '词': { pinyin: 'cí', definition: 'word/lyrics', emoji: '📝', level: 'P4' },
  '语': { pinyin: 'yǔ', definition: 'language', emoji: '🗣️', level: 'P4' },
  '言': { pinyin: 'yán', definition: 'speech/words', emoji: '💬', level: 'P4' },
  '话': { pinyin: 'huà', definition: 'speech/talk', emoji: '🗨️', level: 'P4' },
  '声': { pinyin: 'shēng', definition: 'sound/voice', emoji: '🔊', level: 'P4' },
  '响': { pinyin: 'xiǎng', definition: 'sound/echo', emoji: '🔔', level: 'P4' },
  '静': { pinyin: 'jìng', definition: 'quiet/calm', emoji: '🤫', level: 'P4' },
  '闹': { pinyin: 'nào', definition: 'noisy/lively', emoji: '📢', level: 'P4' },
  '吵': { pinyin: 'chǎo', definition: 'noisy/argue', emoji: '🔊', level: 'P4' },
  '笑': { pinyin: 'xiào', definition: 'laugh/smile', emoji: '😄', level: 'P4' },
  '哭': { pinyin: 'kū', definition: 'cry/weep', emoji: '😭', level: 'P4' },
  '叫': { pinyin: 'jiào', definition: 'call/shout', emoji: '📢', level: 'P4' },
  '喊': { pinyin: 'hǎn', definition: 'shout/yell', emoji: '📣', level: 'P4' },
  '吹': { pinyin: 'chuī', definition: 'blow (wind!)', emoji: '💨', level: 'P4' },
  '风': { pinyin: 'fēng', definition: 'wind/style', emoji: '🌬️', level: 'P4' },
  '雨': { pinyin: 'yǔ', definition: 'rain (water drops!)', emoji: '🌧️', level: 'P4' },
  '雪': { pinyin: 'xuě', definition: 'snow (white flakes!)', emoji: '❄️', level: 'P4' },
  '雷': { pinyin: 'léi', definition: 'thunder (loud sound!)', emoji: '⛈️', level: 'P4' },
  '闪': { pinyin: 'shǎn', definition: 'lightning/flash', emoji: '⚡', level: 'P4' },
  '云': { pinyin: 'yún', definition: 'cloud (in sky!)', emoji: '☁️', level: 'P4' },
  '雾': { pinyin: 'wù', definition: 'fog/mist', emoji: '🌫️', level: 'P4' },
  '露': { pinyin: 'lù', definition: 'dew (morning water!)', emoji: '💧', level: 'P4' },
  '霜': { pinyin: 'shuāng', definition: 'frost (cold morning!)', emoji: '🧊', level: 'P4' },
  '冰': { pinyin: 'bīng', definition: 'ice (frozen water!)', emoji: '🧊', level: 'P4' },
  '冷': { pinyin: 'lěng', definition: 'cold (brrr!)', emoji: '🥶', level: 'P4' },
  '暖': { pinyin: 'nuǎn', definition: 'warm (cozy!)', emoji: '🔥', level: 'P4' },
  '凉': { pinyin: 'liáng', definition: 'cool (nice breeze!)', emoji: '😌', level: 'P4' },
  '温': { pinyin: 'wēn', definition: 'warm/gentle', emoji: '🤗', level: 'P4' },
  '度': { pinyin: 'dù', definition: 'degree/measure', emoji: '🌡️', level: 'P4' },
  '季': { pinyin: 'jì', definition: 'season (spring/summer!)', emoji: '🍂', level: 'P4' },
  '春': { pinyin: 'chūn', definition: 'spring (flowers bloom!)', emoji: '🌸', level: 'P4' },
  '夏': { pinyin: 'xià', definition: 'summer (hot sun!)', emoji: '☀️', level: 'P4' },
  '秋': { pinyin: 'qiū', definition: 'autumn (leaves fall!)', emoji: '🍂', level: 'P4' },
  '冬': { pinyin: 'dōng', definition: 'winter (cold snow!)', emoji: '❄️', level: 'P4' },
  '植': { pinyin: 'zhí', definition: 'plant (grow green!)', emoji: '🌱', level: 'P4' },
  '种': { pinyin: 'zhòng', definition: 'plant/grow seeds', emoji: '🌱', level: 'P4' },
  '养': { pinyin: 'yǎng', definition: 'raise/care for', emoji: '🐣', level: 'P4' },
  '育': { pinyin: 'yù', definition: 'raise/educate', emoji: '🎓', level: 'P4' },
  '培': { pinyin: 'péi', definition: 'cultivate/train', emoji: '🌱', level: 'P4' },
  '训': { pinyin: 'xùn', definition: 'train/practice', emoji: '🏋️', level: 'P4' },
  '练': { pinyin: 'liàn', definition: 'practice/exercise', emoji: '🤸', level: 'P4' },
  '习': { pinyin: 'xí', definition: 'practice/learn', emoji: '📚', level: 'P4' },
  '复': { pinyin: 'fù', definition: 'review/repeat', emoji: '🔄', level: 'P4' },
  '温': { pinyin: 'wēn', definition: 'review (温习)', emoji: '📖', level: 'P4' },
  '预': { pinyin: 'yù', definition: 'preview/prepare', emoji: '👀', level: 'P4' },
  '备': { pinyin: 'bèi', definition: 'prepare/ready', emoji: '✅', level: 'P4' },
  '检': { pinyin: 'jiǎn', definition: 'check/inspect', emoji: '🔍', level: 'P4' },
  '查': { pinyin: 'chá', definition: 'check/investigate', emoji: '🕵️', level: 'P4' },
  '验': { pinyin: 'yàn', definition: 'test/experiment', emoji: '🧪', level: 'P4' },
  '试': { pinyin: 'shì', definition: 'test/try', emoji: '✍️', level: 'P4' },
  '考': { pinyin: 'kǎo', definition: 'exam/test', emoji: '📝', level: 'P4' },
  '评': { pinyin: 'píng', definition: 'evaluate/comment', emoji: '⭐', level: 'P4' },
  '价': { pinyin: 'jià', definition: 'price/value', emoji: '💰', level: 'P4' },
  '值': { pinyin: 'zhí', definition: 'value/worth', emoji: '💎', level: 'P4' },
  '费': { pinyin: 'fèi', definition: 'cost/expense', emoji: '💸', level: 'P4' },
  '花': { pinyin: 'huā', definition: 'spend/flower', emoji: '💰', level: 'P4' },
  '省': { pinyin: 'shěng', definition: 'save money/province', emoji: '💰', level: 'P4' },
  '存': { pinyin: 'cún', definition: 'save/store', emoji: '🏦', level: 'P4' },
  '取': { pinyin: 'qǔ', definition: 'take/withdraw', emoji: '💳', level: 'P4' },
  '换': { pinyin: 'huàn', definition: 'exchange/change', emoji: '🔄', level: 'P4' },
  '票': { pinyin: 'piào', definition: 'ticket/bill', emoji: '🎫', level: 'P4' },
  '证': { pinyin: 'zhèng', definition: 'certificate/ID', emoji: '🆔', level: 'P4' },
  '件': { pinyin: 'jiàn', definition: 'document/item', emoji: '📄', level: 'P4' },
  '申': { pinyin: 'shēn', definition: 'apply/request', emoji: '📋', level: 'P4' },
  '请': { pinyin: 'qǐng', definition: 'apply/please', emoji: '🙏', level: 'P4' },
  '求': { pinyin: 'qiú', definition: 'request/ask for', emoji: '🙋', level: 'P4' },
  '要': { pinyin: 'yào', definition: 'want/need', emoji: '🙏', level: 'P4' },
  '需': { pinyin: 'xū', definition: 'need/require', emoji: '📋', level: 'P4' },
  '必': { pinyin: 'bì', definition: 'must/necessary', emoji: '⚠️', level: 'P4' },
  '须': { pinyin: 'xū', definition: 'must/beard', emoji: '⚠️', level: 'P4' },
  '该': { pinyin: 'gāi', definition: 'should/ought to', emoji: '👍', level: 'P4' },
  '应': { pinyin: 'yìng', definition: 'should/respond', emoji: '✅', level: 'P4' },
  '当': { pinyin: 'dāng', definition: 'should/when', emoji: '⏰', level: 'P4' },
  '宜': { pinyin: 'yí', definition: 'suitable/appropriate', emoji: '👌', level: 'P4' },
  '适': { pinyin: 'shì', definition: 'suitable/fit', emoji: '✅', level: 'P4' },
  '合': { pinyin: 'hé', definition: 'suitable/together', emoji: '🤝', level: 'P4' },
  '配': { pinyin: 'pèi', definition: 'match/pair', emoji: '👫', level: 'P4' },
  '搭': { pinyin: 'dā', definition: 'match/build', emoji: '🏗️', level: 'P4' },
  '建': { pinyin: 'jiàn', definition: 'build/construct', emoji: '🏗️', level: 'P4' },
  '造': { pinyin: 'zào', definition: 'build/make', emoji: '🔨', level: 'P4' },
  '修': { pinyin: 'xiū', definition: 'repair/fix', emoji: '🔧', level: 'P4' },
  '补': { pinyin: 'bǔ', definition: 'repair/mend', emoji: '🩹', level: 'P4' },
  '破': { pinyin: 'pò', definition: 'broken/damaged', emoji: '💔', level: 'P4' },
  '坏': { pinyin: 'huài', definition: 'broken/bad', emoji: '❌', level: 'P4' },
  '损': { pinyin: 'sǔn', definition: 'damaged/harm', emoji: '💥', level: 'P4' },
  '伤': { pinyin: 'shāng', definition: 'hurt/injury', emoji: '🤕', level: 'P4' },
  '害': { pinyin: 'hài', definition: 'harm/damage', emoji: '⚠️', level: 'P4' },
  '治': { pinyin: 'zhì', definition: 'cure/treat', emoji: '💊', level: 'P4' },
  '疗': { pinyin: 'liáo', definition: 'treat/therapy', emoji: '🏥', level: 'P4' },
  '愈': { pinyin: 'yù', definition: 'heal/recover', emoji: '💚', level: 'P4' },
  '康': { pinyin: 'kāng', definition: 'healthy/well', emoji: '💪', level: 'P4' },
  '强': { pinyin: 'qiáng', definition: 'strong/powerful', emoji: '💪', level: 'P4' },
  '壮': { pinyin: 'zhuàng', definition: 'strong/robust', emoji: '🦾', level: 'P4' },
  '弱': { pinyin: 'ruò', definition: 'weak/frail', emoji: '😰', level: 'P4' },
  '虚': { pinyin: 'xū', definition: 'weak/empty', emoji: '🫗', level: 'P4' },
  '实': { pinyin: 'shí', definition: 'real/solid', emoji: '💎', level: 'P4' },
  '空': { pinyin: 'kōng', definition: 'empty/sky', emoji: '🕳️', level: 'P4' },
  '满': { pinyin: 'mǎn', definition: 'full/satisfied', emoji: '🍯', level: 'P4' },
  '够': { pinyin: 'gòu', definition: 'enough/sufficient', emoji: '✅', level: 'P4' },
  '足': { pinyin: 'zú', definition: 'enough/foot', emoji: '👍', level: 'P4' },
  '缺': { pinyin: 'quē', definition: 'lack/missing', emoji: '❌', level: 'P4' },
  '少': { pinyin: 'shǎo', definition: 'few/young', emoji: '👶', level: 'P4' },
  '增': { pinyin: 'zēng', definition: 'increase/add', emoji: '📈', level: 'P4' },
  '加': { pinyin: 'jiā', definition: 'add/plus', emoji: '➕', level: 'P4' },
  '减': { pinyin: 'jiǎn', definition: 'reduce/minus', emoji: '➖', level: 'P4' },
  '除': { pinyin: 'chú', definition: 'divide/except', emoji: '➗', level: 'P4' },
  '乘': { pinyin: 'chéng', definition: 'multiply/ride', emoji: '✖️', level: 'P4' },
  '等': { pinyin: 'děng', definition: 'equal/wait', emoji: '⚖️', level: 'P4' },
  '于': { pinyin: 'yú', definition: 'equal to/at', emoji: '🟰', level: 'P4' },
  '算': { pinyin: 'suàn', definition: 'calculate/count', emoji: '🧮', level: 'P4' },
  '数': { pinyin: 'shù', definition: 'number/count', emoji: '🔢', level: 'P4' },
  '量': { pinyin: 'liàng', definition: 'quantity/measure', emoji: '📏', level: 'P4' },
  '计': { pinyin: 'jì', definition: 'calculate/plan', emoji: '📊', level: 'P4' },
  '总': { pinyin: 'zǒng', definition: 'total/always', emoji: '🔢', level: 'P4' },
  '共': { pinyin: 'gòng', definition: 'total/together', emoji: '🤝', level: 'P4' },
  '同': { pinyin: 'tóng', definition: 'same/together', emoji: '👯', level: 'P4' },
  '异': { pinyin: 'yì', definition: 'different/strange', emoji: '🆚', level: 'P4' },
  '别': { pinyin: 'bié', definition: 'different/don\'t', emoji: '🚫', level: 'P4' },
  '各': { pinyin: 'gè', definition: 'each/every', emoji: '🔄', level: 'P4' },
  '每': { pinyin: 'měi', definition: 'every/each', emoji: '🔁', level: 'P4' },
  '次': { pinyin: 'cì', definition: 'time/occasion', emoji: '🔢', level: 'P4' },
  '回': { pinyin: 'huí', definition: 'time/return', emoji: '🔙', level: 'P4' },
  '遍': { pinyin: 'biàn', definition: 'time/all over', emoji: '🌍', level: 'P4' },
  '趟': { pinyin: 'tàng', definition: 'trip/journey', emoji: '🚶', level: 'P4' },
  '番': { pinyin: 'fān', definition: 'time/foreign', emoji: '🔄', level: 'P4' },
  '轮': { pinyin: 'lún', definition: 'turn/wheel', emoji: '🎡', level: 'P4' },
  '批': { pinyin: 'pī', definition: 'batch/group', emoji: '📦', level: 'P4' },
  '群': { pinyin: 'qún', definition: 'group/crowd', emoji: '👥', level: 'P4' },
  ...
  '民': { pinyin: 'mín', definition: 'people/citizens', emoji: '👥', level: 'P5' },
  '主': { pinyin: 'zhǔ', definition: 'main/master', emoji: '👑', level: 'P5' },
  '义': { pinyin: 'yì', definition: 'justice/meaning', emoji: '⚖️', level: 'P5' },
  '权': { pinyin: 'quán', definition: 'rights/power', emoji: '💪', level: 'P5' },
  '利': { pinyin: 'lì', definition: 'benefit/interest', emoji: '💰', level: 'P5' },
  '平': { pinyin: 'píng', definition: 'equal/peaceful', emoji: '⚖️', level: 'P5' },
  '等': { pinyin: 'děng', definition: 'equal/class', emoji: '🤝', level: 'P5' },
  '由': { pinyin: 'yóu', definition: 'freedom/reason', emoji: '🕊️', level: 'P5' },
  '治': { pinyin: 'zhì', definition: 'govern/cure', emoji: '🏛️', level: 'P5' },
  '法': { pinyin: 'fǎ', definition: 'law/method', emoji: '⚖️', level: 'P5' },
  '律': { pinyin: 'lǜ', definition: 'law/rule', emoji: '📜', level: 'P5' },
  '制': { pinyin: 'zhì', definition: 'system/control', emoji: '🏗️', level: 'P5' },
  '度': { pinyin: 'dù', definition: 'degree/system', emoji: '📏', level: 'P5' },
  '政': { pinyin: 'zhèng', definition: 'politics/government', emoji: '🏛️', level: 'P5' },
  '府': { pinyin: 'fǔ', definition: 'government', emoji: '🏢', level: 'P5' },
  '党': { pinyin: 'dǎng', definition: 'party/group', emoji: '🏛️', level: 'P5' },
  '团': { pinyin: 'tuán', definition: 'group/team', emoji: '👨‍👩‍👧‍👦', level: 'P5' },
  '结': { pinyin: 'jié', definition: 'unite/result', emoji: '🤝', level: 'P5' },
  '合': { pinyin: 'hé', definition: 'combine/together', emoji: '🤝', level: 'P5' },
  '独': { pinyin: 'dú', definition: 'alone/independent', emoji: '🚶', level: 'P5' },
  '立': { pinyin: 'lì', definition: 'stand/establish', emoji: '🏛️', level: 'P5' },
  '争': { pinyin: 'zhēng', definition: 'compete/argue', emoji: '⚔️', level: 'P5' },
  '论': { pinyin: 'lùn', definition: 'discuss/theory', emoji: '💬', level: 'P5' },
  '辩': { pinyin: 'biàn', definition: 'debate/argue', emoji: '🗣️', level: 'P5' },
  '议': { pinyin: 'yì', definition: 'discuss/suggest', emoji: '💭', level: 'P5' },
  '决': { pinyin: 'jué', definition: 'decide/determine', emoji: '✅', level: 'P5' },
  '定': { pinyin: 'dìng', definition: 'decide/fixed', emoji: '📍', level: 'P5' },
  '选': { pinyin: 'xuǎn', definition: 'choose/elect', emoji: '🗳️', level: 'P5' },
  '举': { pinyin: 'jǔ', definition: 'raise/elect', emoji: '🙋', level: 'P5' },
  '投': { pinyin: 'tóu', definition: 'throw/invest', emoji: '🎯', level: 'P5' },
  '票': { pinyin: 'piào', definition: 'vote/ticket', emoji: '🗳️', level: 'P5' },
  '领': { pinyin: 'lǐng', definition: 'lead/receive', emoji: '👑', level: 'P5' },
  '导': { pinyin: 'dǎo', definition: 'guide/lead', emoji: '🧭', level: 'P5' },
  '管': { pinyin: 'guǎn', definition: 'manage/tube', emoji: '🔧', level: 'P5' },
  '理': { pinyin: 'lǐ', definition: 'manage/reason', emoji: '🧠', level: 'P5' },
  '统': { pinyin: 'tǒng', definition: 'unite/system', emoji: '🏗️', level: 'P5' },
  '计': { pinyin: 'jì', definition: 'plan/count', emoji: '📊', level: 'P5' },
  '划': { pinyin: 'huà', definition: 'plan/draw', emoji: '📝', level: 'P5' },
  '建': { pinyin: 'jiàn', definition: 'build/establish', emoji: '🏗️', level: 'P5' },
  '设': { pinyin: 'shè', definition: 'establish/suppose', emoji: '🏗️', level: 'P5' },
  '施': { pinyin: 'shī', definition: 'implement/facility', emoji: '🔧', level: 'P5' },
  '行': { pinyin: 'xíng', definition: 'implement/walk', emoji: '🚶', level: 'P5' },
  '执': { pinyin: 'zhí', definition: 'carry out/hold', emoji: '✊', level: 'P5' },
  '监': { pinyin: 'jiān', definition: 'supervise/monitor', emoji: '👁️', level: 'P5' },
  '督': { pinyin: 'dū', definition: 'supervise/urge', emoji: '👀', level: 'P5' },
  '检': { pinyin: 'jiǎn', definition: 'inspect/check', emoji: '🔍', level: 'P5' },
  '查': { pinyin: 'chá', definition: 'check/investigate', emoji: '🔍', level: 'P5' },
  '审': { pinyin: 'shěn', definition: 'examine/trial', emoji: '⚖️', level: 'P5' },
  '判': { pinyin: 'pàn', definition: 'judge/sentence', emoji: '⚖️', level: 'P5' },
  '罚': { pinyin: 'fá', definition: 'punish/fine', emoji: '💸', level: 'P5' },
  '奖': { pinyin: 'jiǎng', definition: 'reward/prize', emoji: '🏆', level: 'P5' },
  '励': { pinyin: 'lì', definition: 'encourage/motivate', emoji: '📣', level: 'P5' },
  '惩': { pinyin: 'chéng', definition: 'punish/discipline', emoji: '⚠️', level: 'P5' },
  '违': { pinyin: 'wéi', definition: 'violate/against', emoji: '🚫', level: 'P5' },
  '犯': { pinyin: 'fàn', definition: 'commit crime/offend', emoji: '🚔', level: 'P5' },
  '罪': { pinyin: 'zuì', definition: 'crime/sin', emoji: '⚖️', level: 'P5' },
  '恶': { pinyin: 'è', definition: 'evil/bad', emoji: '😈', level: 'P5' },
  '善': { pinyin: 'shàn', definition: 'good/kind', emoji: '😇', level: 'P5' },
  '德': { pinyin: 'dé', definition: 'virtue/morality', emoji: '✨', level: 'P5' },
  '品': { pinyin: 'pǐn', definition: 'character/product', emoji: '⭐', level: 'P5' },
  '格': { pinyin: 'gé', definition: 'character/standard', emoji: '📏', level: 'P5' },
  '修': { pinyin: 'xiū', definition: 'cultivate/repair', emoji: '🛠️', level: 'P5' },
  '养': { pinyin: 'yǎng', definition: 'cultivate/raise', emoji: '🌱', level: 'P5' },
  '育': { pinyin: 'yù', definition: 'educate/nurture', emoji: '🎓', level: 'P5' },
  '培': { pinyin: 'péi', definition: 'cultivate/train', emoji: '🌱', level: 'P5' },
  '训': { pinyin: 'xùn', definition: 'train/teach', emoji: '🏋️', level: 'P5' },
  '练': { pinyin: 'liàn', definition: 'practice/train', emoji: '💪', level: 'P5' },
  '习': { pinyin: 'xí', definition: 'practice/custom', emoji: '📚', level: 'P5' },
  '学': { pinyin: 'xué', definition: 'learn/study', emoji: '📖', level: 'P5' },
  '识': { pinyin: 'shí', definition: 'knowledge/recognize', emoji: '🧠', level: 'P5' },
  '智': { pinyin: 'zhì', definition: 'wisdom/intelligence', emoji: '🦉', level: 'P5' },
  '慧': { pinyin: 'huì', definition: 'wisdom/intelligent', emoji: '💡', level: 'P5' },
  '聪': { pinyin: 'cōng', definition: 'clever/smart', emoji: '🧠', level: 'P5' },
  '明': { pinyin: 'míng', definition: 'bright/clear', emoji: '💡', level: 'P5' },
  '愚': { pinyin: 'yú', definition: 'foolish/stupid', emoji: '🤪', level: 'P5' },
  '笨': { pinyin: 'bèn', definition: 'stupid/clumsy', emoji: '🤦', level: 'P5' },
  '蠢': { pinyin: 'chǔn', definition: 'stupid/foolish', emoji: '😵', level: 'P5' },
  '傻': { pinyin: 'shǎ', definition: 'silly/foolish', emoji: '🤪', level: 'P5' },
  '情': { pinyin: 'qíng', definition: 'emotion/feeling', emoji: '❤️', level: 'P5' },
  '感': { pinyin: 'gǎn', definition: 'feel/sense', emoji: '💭', level: 'P5' },
  '受': { pinyin: 'shòu', definition: 'receive/suffer', emoji: '📨', level: 'P5' },
  '触': { pinyin: 'chù', definition: 'touch/move', emoji: '✋', level: 'P5' },
  '动': { pinyin: 'dòng', definition: 'move/action', emoji: '🏃', level: 'P5' },
  '激': { pinyin: 'jī', definition: 'excite/激动', emoji: '🤩', level: 'P5' },
  '兴': { pinyin: 'xìng', definition: '興 excitement/interest', emoji: '😃', level: 'P5' },
  '奋': { pinyin: 'fèn', definition: 'strive/excited', emoji: '🔥', level: 'P5' },
  '振': { pinyin: 'zhèn', definition: 'shake/inspire', emoji: '💪', level: 'P5' },
  '鼓': { pinyin: 'gǔ', definition: 'drum/encourage', emoji: '🥁', level: 'P5' },
  '舞': { pinyin: 'wǔ', definition: 'dance/inspire', emoji: '💃', level: 'P5' },
  '慰': { pinyin: 'wèi', definition: 'comfort/console', emoji: '🫂', level: 'P5' },
  '安': { pinyin: 'ān', definition: 'peaceful/安全', emoji: '☮️', level: 'P5' },
  '静': { pinyin: 'jìng', definition: 'quiet/calm', emoji: '😌', level: 'P5' },
  '稳': { pinyin: 'wěn', definition: 'stable/steady', emoji: '⚖️', level: 'P5' },
  '定': { pinyin: 'dìng', definition: 'stable/decide', emoji: '📍', level: 'P5' },
  '乱': { pinyin: 'luàn', definition: 'chaos/mess', emoji: '🌪️', level: 'P5' },
  '忙': { pinyin: 'máng', definition: 'busy/hurried', emoji: '⏰', level: 'P5' },
  '急': { pinyin: 'jí', definition: 'urgent/anxious', emoji: '😰', level: 'P5' },
  '慌': { pinyin: 'huāng', definition: 'panic/flustered', emoji: '😱', level: 'P5' },
  '张': { pinyin: 'zhāng', definition: 'nervous/tension', emoji: '😬', level: 'P5' },
  '松': { pinyin: 'sōng', definition: 'loose/relaxed', emoji: '😌', level: 'P5' },
  '轻': { pinyin: 'qīng', definition: 'light/relaxed', emoji: '🪶', level: 'P5' },
  '重': { pinyin: 'zhòng', definition: 'heavy/serious', emoji: '⚖️', level: 'P5' },
  '严': { pinyin: 'yán', definition: 'strict/serious', emoji: '😤', level: 'P5' },
  '格': { pinyin: 'gé', definition: 'strict/standard', emoji: '📏', level: 'P5' },
  '密': { pinyin: 'mì', definition: 'dense/secret', emoji: '🤐', level: 'P5' },
  '切': { pinyin: 'qiè', definition: 'close/urgent', emoji: '🔗', level: 'P5' },
  '近': { pinyin: 'jìn', definition: 'close/recent', emoji: '📍', level: 'P5' },
  '远': { pinyin: 'yuǎn', definition: 'far/distant', emoji: '🌌', level: 'P5' },
  '深': { pinyin: 'shēn', definition: 'deep/profound', emoji: '🕳️', level: 'P5' },
  '浅': { pinyin: 'qiǎn', definition: 'shallow/superficial', emoji: '🏊', level: 'P5' },
  '广': { pinyin: 'guǎng', definition: 'wide/broad', emoji: '↔️', level: 'P5' },
  '窄': { pinyin: 'zhǎi', definition: 'narrow/limited', emoji: '🤏', level: 'P5' },
  '宽': { pinyin: 'kuān', definition: 'wide/tolerant', emoji: '🫂', level: 'P5' },
  '阔': { pinyin: 'kuò', definition: 'broad/wealthy', emoji: '💰', level: 'P5' },
  '丰': { pinyin: 'fēng', definition: 'abundant/rich', emoji: '🌾', level: 'P5' },
  '富': { pinyin: 'fù', definition: 'rich/wealthy', emoji: '💰', level: 'P5' },
  '贫': { pinyin: 'pín', definition: 'poor/lacking', emoji: '😔', level: 'P5' },
  '穷': { pinyin: 'qióng', definition: 'poor/exhausted', emoji: '💸', level: 'P5' },
  '困': { pinyin: 'kùn', definition: 'difficult/trapped', emoji: '😰', level: 'P5' },
  '苦': { pinyin: 'kǔ', definition: 'bitter/suffering', emoji: '😖', level: 'P5' },
  '难': { pinyin: 'nán', definition: 'difficult/hard', emoji: '💪', level: 'P5' },
  '易': { pinyin: 'yì', definition: 'easy/change', emoji: '✅', level: 'P5' },
  '简': { pinyin: 'jiǎn', definition: 'simple/brief', emoji: '✂️', level: 'P5' },
  '单': { pinyin: 'dān', definition: 'single/simple', emoji: '1️⃣', level: 'P5' },
  '复': { pinyin: 'fù', definition: 'complex/repeat', emoji: '🧩', level: 'P5' },
  '杂': { pinyin: 'zá', definition: 'mixed/complex', emoji: '🌀', level: 'P5' },
  '乱': { pinyin: 'luàn', definition: 'chaotic/messy', emoji: '🌪️', level: 'P5' },
  '整': { pinyin: 'zhěng', definition: 'whole/tidy', emoji: '📏', level: 'P5' },
  '齐': { pinyin: 'qí', definition: 'neat/complete', emoji: '📐', level: 'P5' },
  '洁': { pinyin: 'jié', definition: 'clean/pure', emoji: '✨', level: 'P5' },
  '净': { pinyin: 'jìng', definition: 'clean/net', emoji: '🧼', level: 'P5' },
  '脏': { pinyin: 'zāng', definition: 'dirty/organ', emoji: '🧽', level: 'P5' },
  '污': { pinyin: 'wū', definition: 'dirty/pollute', emoji: '🏭', level: 'P5' },
  '臭': { pinyin: 'chòu', definition: 'smelly/stink', emoji: '🦨', level: 'P5' },
  '香': { pinyin: 'xiāng', definition: 'fragrant/sweet', emoji: '🌹', level: 'P5' },
  '甜': { pinyin: 'tián', definition: 'sweet/pleasant', emoji: '🍯', level: 'P5' },
  '酸': { pinyin: 'suān', definition: 'sour/acidic', emoji: '🍋', level: 'P5' },
  '辣': { pinyin: 'là', definition: 'spicy/hot', emoji: '🌶️', level: 'P5' },
  '咸': { pinyin: 'xián', definition: 'salty/salted', emoji: '🧂', level: 'P5' },
  '淡': { pinyin: 'dàn', definition: 'bland/light', emoji: '💧', level: 'P5' },
  '浓': { pinyin: 'nóng', definition: 'thick/strong', emoji: '☕', level: 'P5' },
  '薄': { pinyin: 'báo', definition: 'thin/weak', emoji: '📄', level: 'P5' },
  '厚': { pinyin: 'hòu', definition: 'thick/generous', emoji: '📚', level: 'P5' },
  '细': { pinyin: 'xì', definition: 'thin/detailed', emoji: '🧵', level: 'P5' },
  '粗': { pinyin: 'cū', definition: 'thick/rough', emoji: '🪵', level: 'P5' },
  '滑': { pinyin: 'huá', definition: 'smooth/slippery', emoji: '🧊', level: 'P5' },
  '糙': { pinyin: 'cāo', definition: 'rough/coarse', emoji: '🪨', level: 'P5' },
  '硬': { pinyin: 'yìng', definition: 'hard/tough', emoji: '💎', level: 'P5' },
  '软': { pinyin: 'ruǎn', definition: 'soft/gentle', emoji: '🪶', level: 'P5' },
  '紧': { pinyin: 'jǐn', definition: 'tight/urgent', emoji: '🔒', level: 'P5' },
  '慢': { pinyin: 'màn', definition: 'slow/gradual', emoji: '🐌', level: 'P5' },
  '快': { pinyin: 'kuài', definition: 'fast/quick', emoji: '⚡', level: 'P5' },
  '速': { pinyin: 'sù', definition: 'speed/fast', emoji: '💨', level: 'P5' },
  '迟': { pinyin: 'chí', definition: 'late/slow', emoji: '⏰', level: 'P5' },
  '早': { pinyin: 'zǎo', definition: 'early/morning', emoji: '🌅', level: 'P5' },
  '晚': { pinyin: 'wǎn', definition: 'late/evening', emoji: '🌆', level: 'P5' },
  '急': { pinyin: 'jí', definition: 'urgent/急', emoji: '🚨', level: 'P5' },
  '忙': { pinyin: 'máng', definition: 'busy/hurried', emoji: '⏳', level: 'P5' },
  '闲': { pinyin: 'xián', definition: 'free/leisure', emoji: '😌', level: 'P5' },
  '空': { pinyin: 'kōng', definition: 'empty/free', emoji: '🕳️', level: 'P5' },
  '满': { pinyin: 'mǎn', definition: 'full/satisfied', emoji: '💯', level: 'P5' },
  '够': { pinyin: 'gòu', definition: 'enough/sufficient', emoji: '✅', level: 'P5' },
  '缺': { pinyin: 'quē', definition: 'lack/missing', emoji: '❌', level: 'P5' },
  '少': { pinyin: 'shǎo', definition: 'few/young', emoji: '🤏', level: 'P5' },
  '多': { pinyin: 'duō', definition: 'many/much', emoji: '📈', level: 'P5' },
  '够': { pinyin: 'gòu', definition: 'sufficient/enough', emoji: '✔️', level: 'P5' },
  '余': { pinyin: 'yú', definition: 'surplus/remaining', emoji: '➕', level: 'P5' },
  '剩': { pinyin: 'shèng', definition: 'leftover/remain', emoji: '🍽️', level: 'P5' },
  '存': { pinyin: 'cún', definition: 'exist/save', emoji: '💾', level: 'P5' },
  '留': { pinyin: 'liú', definition: 'stay/keep', emoji: '📌', level: 'P5' },
  '守': { pinyin: 'shǒu', definition: 'guard/keep', emoji: '🛡️', level: 'P5' },
  '护': { pinyin: 'hù', definition: 'protect/guard', emoji: '🛡️', level: 'P5' },
  '卫': { pinyin: 'wèi', definition: 'defend/guard', emoji: '⚔️', level: 'P5' },
  '救': { pinyin: 'jiù', definition: 'save/rescue', emoji: '🚑', level: 'P5' },
  '助': { pinyin: 'zhù', definition: 'help/assist', emoji: '🤝', level: 'P5' },
  '援': { pinyin: 'yuán', definition: 'help/support', emoji: '💪', level: 'P5' },
  '支': { pinyin: 'zhī', definition: 'support/branch', emoji: '🌿', level: 'P5' },
  '持': { pinyin: 'chí', definition: 'hold/support', emoji: '✊', level: 'P5' },
  '撑': { pinyin: 'chēng', definition: 'support/prop', emoji: '🏗️', level: 'P5' },
  '靠': { pinyin: 'kào', definition: 'lean on/rely', emoji: '🫂', level: 'P5' },
  '依': { pinyin: 'yī', definition: 'depend/according', emoji: '🤗', level: 'P5' },
  '赖': { pinyin: 'lài', definition: 'rely/depend', emoji: '🤝', level: 'P5' },
  '仗': { pinyin: 'zhàng', definition: 'rely on/fight', emoji: '⚔️', level: 'P5' },
  '借': { pinyin: 'jiè', definition: 'borrow/lend', emoji: '🤲', level: 'P5' },
  '贷': { pinyin: 'dài', definition: 'loan/lend', emoji: '💳', level: 'P5' },
  '欠': { pinyin: 'qiàn', definition: 'owe/lack', emoji: '💸', level: 'P5' },
  '债': { pinyin: 'zhài', definition: 'debt/liability', emoji: '📜', level: 'P5' },
  '还': { pinyin: 'huán', definition: 'return/pay back', emoji: '↩️', level: 'P5' },
  '偿': { pinyin: 'cháng', definition: 'compensate/repay', emoji: '💰', level: 'P5' },
  '补': { pinyin: 'bǔ', definition: 'supplement/mend', emoji: '🩹', level: 'P5' },
  '填': { pinyin: 'tián', definition: 'fill/complete', emoji: '📝', level: 'P5' },
  '充': { pinyin: 'chōng', definition: 'fill/充电', emoji: '🔋', level: 'P5' },
  '装': { pinyin: 'zhuāng', definition: 'pack/install', emoji: '📦', level: 'P5' },
  '载': { pinyin: 'zài', definition: 'load/carry', emoji: '🚛', level: 'P5' },
  '担': { pinyin: 'dān', definition: 'carry/burden', emoji: '🎒', level: 'P5' },
  '负': { pinyin: 'fù', definition: 'carry/负responsibility', emoji: '🎒', level: 'P5' },
  '背': { pinyin: 'bēi', definition: 'carry/back', emoji: '🎒', level: 'P5' },
  '扛': { pinyin: 'káng', definition: 'carry/shoulder', emoji: '💪', level: 'P5' },
  '抬': { pinyin: 'tái', definition: 'lift/carry', emoji: '🏋️', level: 'P5' },
  '举': { pinyin: 'jǔ', definition: 'lift/举例', emoji: '🙋', level: 'P5' },
  '升': { pinyin: 'shēng', definition: 'rise/promote', emoji: '📈', level: 'P5' },
  '降': { pinyin: 'jiàng', definition: 'fall/降低', emoji: '📉', level: 'P5' },
  '落': { pinyin: 'luò', definition: 'fall/settle', emoji: '🍂', level: 'P5' },
  '掉': { pinyin: 'diào', definition: 'fall/drop', emoji: '📉', level: 'P5' },
  '倒': { pinyin: 'dǎo', definition: 'fall/pour', emoji: '🫗', level: 'P5' },
  '翻': { pinyin: 'fān', definition: 'turn/flip', emoji: '🔄', level: 'P5' },
  '转': { pinyin: 'zhuǎn', definition: 'turn/transfer', emoji: '🔄', level: 'P5' },
  '换': { pinyin: 'huàn', definition: 'change/exchange', emoji: '🔄', level: 'P5' },
  '替': { pinyin: 'tì', definition: 'replace/substitute', emoji: '🔄', level: 'P5' },
  '代': { pinyin: 'dài', definition: 'replace/generation', emoji: '👨‍👦', level: 'P5' },
  '表': { pinyin: 'biǎo', definition: 'represent/表示', emoji: '📊', level: 'P5' },
  '示': { pinyin: 'shì', definition: 'show/demonstrate', emoji: '👉', level: 'P5' },
  '指': { pinyin: 'zhǐ', definition: 'point/finger', emoji: '👆', level: 'P5' },
  '导': { pinyin: 'dǎo', definition: 'guide/导师', emoji: '🧭', level: 'P5' },
  '引': { pinyin: 'yǐn', definition: 'lead/attract', emoji: '🧲', level: 'P5' },
  '带': { pinyin: 'dài', definition: '带来/belt', emoji: '🎀', level: 'P5' },
  '拉': { pinyin: 'lā', definition: 'pull/拉', emoji: '🪢', level: 'P5' },
  '推': { pinyin: 'tuī', definition: 'push/promote', emoji: '👐', level: 'P5' },
  '移': { pinyin: 'yí', definition: 'move/shift', emoji: '➡️', level: 'P5' },
  '动': { pinyin: 'dòng', definition: 'move/动作', emoji: '🏃', level: 'P5' },
  '摇': { pinyin: 'yáo', definition: 'shake/rock', emoji: '🪨', level: 'P5' },
  '摆': { pinyin: 'bǎi', definition: 'swing/arrange', emoji: '🔄', level: 'P5' },
  '放': { pinyin: 'fàng', definition: 'put/release', emoji: '📦', level: 'P5' },
  '置': { pinyin: 'zhì', definition: 'place/position', emoji: '📍', level: 'P5' },
  '排': { pinyin: 'pái', definition: 'arrange/row', emoji: '📏', level: 'P5' },
  '列': { pinyin: 'liè', definition: 'list/row', emoji: '📝', level: 'P5' },
  '队': { pinyin: 'duì', definition: 'team/queue', emoji: '👥', level: 'P5' },
  '组': { pinyin: 'zǔ', definition: 'group/organize', emoji: '👨‍👩‍👧‍👦', level: 'P5' },
  '织': { pinyin: 'zhī', definition: 'weave/organize', emoji: '🧶', level: 'P5' },
  '编': { pinyin: 'biān', definition: 'compile/编织', emoji: '📝', level: 'P5' },
  '造': { pinyin: 'zào', definition: 'create/make', emoji: '🏗️', level: 'P5' },
  '制': { pinyin: 'zhì', definition: 'make/system', emoji: '🛠️', level: 'P5' },
  '产': { pinyin: 'chǎn', definition: 'produce/property', emoji: '🏭', level: 'P5' },
  '生': { pinyin: 'shēng', definition: 'produce/生活', emoji: '🌱', level: 'P5' },
  ...
  '辩': { pinyin: 'biàn', definition: 'debate/argue logically', emoji: '🗣️', level: 'P6' },
  '逻': { pinyin: 'luó', definition: 'logic/reasoning', emoji: '🧠', level: 'P6' },
  '辑': { pinyin: 'jí', definition: 'logic/collect', emoji: '🔗', level: 'P6' },
  '推': { pinyin: 'tuī', definition: 'infer/deduce', emoji: '➡️', level: 'P6' },
  '证': { pinyin: 'zhèng', definition: 'prove/evidence', emoji: '✅', level: 'P6' },
  '据': { pinyin: 'jù', definition: 'evidence/according to', emoji: '📊', level: 'P6' },
  '假': { pinyin: 'jiǎ', definition: 'hypothesis/假设', emoji: '❓', level: 'P6' },
  '设': { pinyin: 'shè', definition: 'establish/suppose', emoji: '🏗️', level: 'P6' },
  '范': { pinyin: 'fàn', definition: 'scope/example', emoji: '📏', level: 'P6' },
  '围': { pinyin: 'wéi', definition: 'surround/scope', emoji: '🔄', level: 'P6' },
  '含': { pinyin: 'hán', definition: 'contain/include', emoji: '📦', level: 'P6' },
  '概': { pinyin: 'gài', definition: 'general/概念', emoji: '🌐', level: 'P6' },
  '括': { pinyin: 'kuò', definition: 'include/括', emoji: '🫂', level: 'P6' },
  '除': { pinyin: 'chú', definition: 'except/除外', emoji: '➖', level: 'P6' },
  '增': { pinyin: 'zēng', definition: 'increase/add', emoji: '📈', level: 'P6' },
  '减': { pinyin: 'jiǎn', definition: 'decrease/reduce', emoji: '📉', level: 'P6' },
  '扩': { pinyin: 'kuò', definition: 'expand/broaden', emoji: '📏', level: 'P6' },
  '缩': { pinyin: 'suō', definition: 'shrink/contract', emoji: '📐', level: 'P6' },
  '限': { pinyin: 'xiàn', definition: 'limit/restrict', emoji: '🚧', level: 'P6' },
  '制': { pinyin: 'zhì', definition: 'control/system', emoji: '🎛️', level: 'P6' },
  '控': { pinyin: 'kòng', definition: 'control/manage', emoji: '🎮', level: 'P6' },
  '管': { pinyin: 'guǎn', definition: 'manage/tube', emoji: '🔧', level: 'P6' },
  '监': { pinyin: 'jiān', definition: 'supervise/monitor', emoji: '👁️', level: 'P6' },
  '督': { pinyin: 'dū', definition: 'supervise/urge', emoji: '👀', level: 'P6' },
  '检': { pinyin: 'jiǎn', definition: 'inspect/examine', emoji: '🔍', level: 'P6' },
  '查': { pinyin: 'chá', definition: 'investigate/check', emoji: '🕵️', level: 'P6' },
  '核': { pinyin: 'hé', definition: 'nuclear/core/verify', emoji: '⚛️', level: 'P6' },
  '审': { pinyin: 'shěn', definition: 'examine/trial', emoji: '⚖️', level: 'P6' },
  '批': { pinyin: 'pī', definition: 'criticize/批准', emoji: '✍️', level: 'P6' },
  '准': { pinyin: 'zhǔn', definition: 'approve/standard', emoji: '✅', level: 'P6' },
  '否': { pinyin: 'fǒu', definition: 'deny/or not', emoji: '❌', level: 'P6' },
  '拒': { pinyin: 'jù', definition: 'refuse/reject', emoji: '🚫', level: 'P6' },
  '绝': { pinyin: 'jué', definition: 'absolute/refuse', emoji: '⛔', level: 'P6' },
  '禁': { pinyin: 'jìn', definition: 'forbid/prohibit', emoji: '🚫', level: 'P6' },
  '止': { pinyin: 'zhǐ', definition: 'stop/prevent', emoji: '✋', level: 'P6' },
  '阻': { pinyin: 'zǔ', definition: 'block/obstruct', emoji: '🚧', level: 'P6' },
  '挡': { pinyin: 'dǎng', definition: 'block/shield', emoji: '🛡️', level: 'P6' },
  '碍': { pinyin: 'ài', definition: 'hinder/obstacle', emoji: '🚧', level: 'P6' },
  '障': { pinyin: 'zhàng', definition: 'obstacle/barrier', emoji: '🚧', level: 'P6' },
  '壁': { pinyin: 'bì', definition: 'wall/barrier', emoji: '🧱', level: 'P6' },
  '墙': { pinyin: 'qiáng', definition: 'wall/barrier', emoji: '🧱', level: 'P6' },
  '围': { pinyin: 'wéi', definition: 'surround/encircle', emoji: '🔄', level: 'P6' },
  '绕': { pinyin: 'rào', definition: 'wind around/bypass', emoji: '🌀', level: 'P6' },
  '避': { pinyin: 'bì', definition: 'avoid/evade', emoji: '🚶‍♂️', level: 'P6' },
  '免': { pinyin: 'miǎn', definition: 'avoid/exempt', emoji: '🆓', level: 'P6' },
  '逃': { pinyin: 'táo', definition: 'escape/flee', emoji: '🏃‍♂️', level: 'P6' },
  '躲': { pinyin: 'duǒ', definition: 'hide/dodge', emoji: '🫥', level: 'P6' },
  '藏': { pinyin: 'cáng', definition: 'hide/conceal', emoji: '🫥', level: 'P6' },
  '露': { pinyin: 'lù', definition: 'reveal/expose', emoji: '👁️', level: 'P6' },
  '显': { pinyin: 'xiǎn', definition: 'show/obvious', emoji: '💡', level: 'P6' },
  '示': { pinyin: 'shì', definition: 'show/demonstrate', emoji: '👉', level: 'P6' },
  '告': { pinyin: 'gào', definition: 'tell/inform', emoji: '📢', level: 'P6' },
  '诉': { pinyin: 'sù', definition: 'tell/sue', emoji: '🗣️', level: 'P6' },
  '申': { pinyin: 'shēn', definition: 'state/申请', emoji: '📝', level: 'P6' },
  '报': { pinyin: 'bào', definition: 'report/newspaper', emoji: '📰', level: 'P6' },
  '登': { pinyin: 'dēng', definition: 'register/climb', emoji: '📋', level: 'P6' },
  '记': { pinyin: 'jì', definition: 'record/remember', emoji: '📝', level: 'P6' },
  '录': { pinyin: 'lù', definition: 'record/录音', emoji: '🎙️', level: 'P6' },
  '存': { pinyin: 'cún', definition: 'save/exist', emoji: '💾', level: 'P6' },
  '档': { pinyin: 'dàng', definition: 'file/档案', emoji: '📁', level: 'P6' },
  '案': { pinyin: 'àn', definition: 'case/plan', emoji: '📋', level: 'P6' },
  '卷': { pinyin: 'juàn', definition: 'volume/roll up', emoji: '📜', level: 'P6' },
  '册': { pinyin: 'cè', definition: 'book/volume', emoji: '📖', level: 'P6' },
  '本': { pinyin: 'běn', definition: 'book/original', emoji: '📚', level: 'P6' },
  '版': { pinyin: 'bǎn', definition: 'edition/版本', emoji: '📄', level: 'P6' },
  '刊': { pinyin: 'kān', definition: 'publish/periodical', emoji: '📰', level: 'P6' },
  '印': { pinyin: 'yìn', definition: 'print/印象', emoji: '🖨️', level: 'P6' },
  '刷': { pinyin: 'shuā', definition: 'print/brush', emoji: '🖨️', level: 'P6' },
  '传': { pinyin: 'chuán', definition: '传播/传统', emoji: '📡', level: 'P6' },
  '播': { pinyin: 'bō', definition: 'broadcast/sow', emoji: '📻', level: 'P6' },
  '送': { pinyin: 'sòng', definition: 'send/deliver', emoji: '📦', level: 'P6' },
  '递': { pinyin: 'dì', definition: 'deliver/递给', emoji: '📨', level: 'P6' },
  '运': { pinyin: 'yùn', definition: 'transport/luck', emoji: '🚛', level: 'P6' },
  '输': { pinyin: 'shū', definition: 'transport/lose', emoji: '🚚', level: 'P6' },
  '载': { pinyin: 'zài', definition: 'carry/load', emoji: '🚛', level: 'P6' },
  '装': { pinyin: 'zhuāng', definition: 'load/dress', emoji: '📦', level: 'P6' },
  '卸': { pinyin: 'xiè', definition: 'unload/remove', emoji: '📦', level: 'P6' },
  '货': { pinyin: 'huò', definition: 'goods/cargo', emoji: '📦', level: 'P6' },
  '物': { pinyin: 'wù', definition: 'thing/物品', emoji: '📦', level: 'P6' },
  '品': { pinyin: 'pǐn', definition: 'product/character', emoji: '🏷️', level: 'P6' },
  '牌': { pinyin: 'pái', definition: 'brand/card', emoji: '🏷️', level: 'P6' },
  '标': { pinyin: 'biāo', definition: 'mark/标准', emoji: '🏷️', level: 'P6' },
  '签': { pinyin: 'qiān', definition: 'sign/签名', emoji: '✍️', level: 'P6' },
  '名': { pinyin: 'míng', definition: 'name/famous', emoji: '📛', level: 'P6' },
  '称': { pinyin: 'chēng', definition: 'call/weigh', emoji: '📛', level: 'P6' },
  '号': { pinyin: 'hào', definition: 'number/号码', emoji: '🔢', level: 'P6' },
  '码': { pinyin: 'mǎ', definition: 'code/number', emoji: '🔢', level: 'P6' },
  '序': { pinyin: 'xù', definition: 'order/sequence', emoji: '📝', level: 'P6' },
  '列': { pinyin: 'liè', definition: 'list/row', emoji: '📋', level: 'P6' },
  '排': { pinyin: 'pái', definition: 'arrange/row', emoji: '📏', level: 'P6' },
  '队': { pinyin: 'duì', definition: 'team/queue', emoji: '👥', level: 'P6' },
  '组': { pinyin: 'zǔ', definition: 'group/organize', emoji: '👨‍👩‍👧‍👦', level: 'P6' },
  '织': { pinyin: 'zhī', definition: 'weave/organize', emoji: '🧶', level: 'P6' },
  '构': { pinyin: 'gòu', definition: 'construct/structure', emoji: '🏗️', level: 'P6' },
  '建': { pinyin: 'jiàn', definition: 'build/establish', emoji: '🏗️', level: 'P6' },
  '筑': { pinyin: 'zhù', definition: 'build/construct', emoji: '🏗️', level: 'P6' },
  '造': { pinyin: 'zào', definition: 'create/make', emoji: '🛠️', level: 'P6' },
  '制': { pinyin: 'zhì', definition: 'make/system', emoji: '⚙️', level: 'P6' },
  '产': { pinyin: 'chǎn', definition: 'produce/property', emoji: '🏭', level: 'P6' }
};
